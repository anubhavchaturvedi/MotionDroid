...
public class MainActivity extends Activity implements SensorEventListener {
	...
	private boolean TERMINATE_TRANSMISSION=false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button terminateTransmission = (Button)findViewById(R.id.button1);
        terminateTransmission.setOnClickListener(new OnClickListener() {
			@Override
